...
public class ViewEmployeeList extends javax.swing.JFrame {
   ...
   private ArrayList<Employee> employeeList=new ArrayList<>();
    /**
     * Creates new form ViewEmployeeList
     * 
     */
   
   
   public ViewEmployeeList(ArrayList<Employee> employeeList){
 ...
 sb.append("EMP ID\tNAME\tSURNAME\tJOB TITLE\t  DEPARTMENT\n");
 sb.append("-----------------------------------------------------\n");
          
     for(Employee emp:employeeList){
              sb.append(emp.getID()).append("\t")
              .append(emp.getName()).append("\t")
              .append(emp.getSurname()).append("\t")
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewEmployeeList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
